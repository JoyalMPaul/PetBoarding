...
namespace PetBoarding.Models
{
    ...
    public class RegisterViewModel
    {
        ...
        [Required]
        [StringLength(25, ErrorMessage = "Firstname should be between 1 and 25 characters long", MinimumLength = 1)]
        [Display(Name = "First Name")]
        public string FirstName { get; set; }

        [Required]
        [StringLength(25, ErrorMessage = "Username should be between 1 and 25 characters long", MinimumLength = 1)]
